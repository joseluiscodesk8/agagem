...
const PulseraDuo = () => {
  ...
  let currentPage = 1;
  const imagesToShow = [tiposPulseras][currentPage - 1];
      ...
      >
        {imagesToShow.map((image, index) => (
          <section key={index}>
            ...
            <p>
              Duo de Pulseras en murano, elásticas con 2 dijes en zamak y
              separadores en acero. Los dijes pueden cambiar según
